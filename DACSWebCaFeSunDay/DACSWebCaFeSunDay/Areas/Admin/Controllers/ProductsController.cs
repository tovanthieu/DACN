    ...
    public class ProductsController : Controller
    {
        ...
        public ActionResult Edit(Product model, List<string> Images, List<int> rDefault)
        {
            if (ModelState.IsValid)
            {
                ...
                existingProduct.Alias = DACSWebCaFeSunDay.Models.Common.Filter.FilterChar(model.Title);
                ...
                existingProduct.Modifierdate = DateTime.Now;

             
                if (Images != null && Images.Count > 0)
                {
                    existingProduct.Image = Images[0]; 
