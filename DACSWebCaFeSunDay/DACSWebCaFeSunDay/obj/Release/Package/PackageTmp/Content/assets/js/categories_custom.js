...
jQuery(document).ready(function ($) {
			...
			filterButton.on('click', function () {
				$('.product-grid').isotope({
					filter: function () {
						...
						var priceMin = parseFloat(priceRange.split('-')[0].replace('đ', '').replace(/,/g, ''));
						var priceMax = parseFloat(priceRange.split('-')[1].replace('đ', '').replace(/,/g, ''));
				...
				$("#amount").val(numberWithCommas(parseFloat($("#slider-range").slider("values", 0))) + " đ" + " - " + numberWithCommas(parseFloat($("#slider-range").slider("values", 1))) + " đ");
			});
	...
	*/
	...
	function initPriceSlider() {
		...
		$("#amount").val(numberWithCommas($("#slider-range").slider("values", 0)) + " đ" + " - " + numberWithCommas($("#slider-range").slider("values", 1)) + " đ");
	}
